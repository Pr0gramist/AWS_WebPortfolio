...
import KnowBe1 from '../files/KnowBe4-1.pdf';
import KnowBe2 from '../files/KnowBe4-2.pdf';
import KnowBe3 from '../files/KnowBe4-3.pdf';
import KnowBe4 from '../files/KnowBe4-4.pdf';
import KnowBe5 from '../files/KnowBe4-5.pdf';
import KnowBe6 from '../files/KnowBe4-6.pdf';
import KnowBe7 from '../files/KnowBe4-7.pdf';
import KnowBe8 from '../files/KnowBe4-8.pdf';
import KnowBe9 from '../files/KnowBe4-9.pdf';
import KnowBe10 from '../files/KnowBe4-10.pdf';
            ...
            <div className="wrap">
                <div id="homepage_banner" class="jumbotron text-center">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-4">
                            <i id="thankspage_icons" class="fa fa-certificate"></i>
                            <h1 id="white_background_text"><b>Certifications</b></h1>
                            <hr id="half_line"></hr>
                        </div>
                        <div class="col-md-4">
                        </div>
